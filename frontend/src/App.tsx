...
import { RatingsManagePage } from '@/pages/RatingsManagePage'
  ...
  return (
    <Routes>
      ...
      <Route element={<AppLayout />}>
        ...
        <Route path="ratings" element={<RatingsManagePage />} />
        <Route path="responses" element={<Navigate to="/ratings" replace />} />
